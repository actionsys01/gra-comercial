...
export default function Empresas() {
  ...
  function edit(
    { nome_fantasia, razao_social, email, cnpj, id }: CompanyProps,
    accountData: PlanoProps,
  ) {
  ...
  async function deleteCompany() {
    try {
      ...
      const usuariosAtualizados = company?.filter(
              ...
              content={[
                {
                  optionName: 'Editar',
                  onClick: () => {
                    const accountData = item.plano;
                    edit(item, accountData);
                  },
                },
